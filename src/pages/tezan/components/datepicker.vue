...
import AmNavBar from './navbar'
import AmDatePickerView from './datepickerview'
import ListItemMixin from './item-mixin'
const prpos = require('./datepickerprops.js').default()
...
export default {
  ...
  watch: {
    currentShow (val) {
	  if (this.currentValue == "" && this.defaultDate != "")
	  {
		  this.currentValue = this.defaultDate;
	  }
      if (this.show !== val) {
